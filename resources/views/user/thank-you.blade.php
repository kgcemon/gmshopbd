...
@section('content')
    ...
    <div class="op-page">
        ...
        <div class="op-header">
            ...
            <h1>Order Placed!</h1>
            <p> {{$order->status == 'hold' ? 'আপুনার দেওয়া ট্রানজেকশন আইডি দিয়ে কোন পেমেন্ট পাওয়া যায়নি দয়া করে সঠিক ট্রানজেকশন আইডি দিয়ে আবার অর্ডার করুন অথবা এডমিনের সাথে যোগাযোগ করুন' : "অভিনন্দন আপনার পেমেন্ট পেয়ছি ১-৩০ সেকেন্ডের মাধ্যেই আপনার অর্ডার ডেলিভারি দেওয়া হবে" }}</p>
        </div>
